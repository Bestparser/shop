...
class Shop_Model_Delivery_SelfDelivery3 extends Shop_Model_Delivery
{
	
	public function getName()
	{
		return 'Самовывоз ул. Лескова';
	}
	
	public function getDescr($addDay = null)
	{
		$url = $this->getRoadmapUrl('planetiron');
		$shopSmapper = new CatCommon_Model_Mapper_Shops();
		$findDeliveryDay = $shopSmapper->find(3);
		if (empty($addDay)) {
